...
$data2 = mysql_fetch_array($query_absensi);
$nip = $data2['nip'];

$cari_nama = mysql_query("SELECT * FROM karyawan WHERE nip = '$nip'") or die(mysql_error());
$dapet_nama = mysql_fetch_array($cari_nama);
...
$pdf->Cell(0, 6, 'Nama karyawan : ' . $dapet_nama['nama_karyawan'], 0, 1, 'C');
$pdf->ln();
