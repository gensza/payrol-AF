        ...
        <div class="widget widget-table">
            <div class="row justify-content-between ml-0 mr-0 mb-2">
                ...
                <div class="actions mt-2" align="right">
                    ...
                    <button type="button" onclick="self.history.back()" class="btn btn-sm btn-secondary">Batal</button>
                </div> <!-- .actions -->
            </div>
                    ...
                    <tbody>
                        <tr class="gradeA odd">
                            ...
                            <td>
                                <div class="field-group inlineField">
                                    <div class="field">
                                        <input type="text" name="waktu_masuk" id="timepicker_masuk" value="<?php echo $data['waktu_masuk']; ?>" class="validate[required] form-control form-control-sm">
                                    </div> <!-- .field -->
                                </div> <!-- .field-group -->
                            </td>
                            <td>
                                <div class="field-group inlineField">
                                    <div class="field">
                                        <input type="text" name="waktu_keluar" id="timepicker_keluar" value="<?php echo $data['waktu_keluar']; ?>" class="validate[required] form-control form-control-sm" />
                                    </div> <!-- .field -->
                                </div> <!-- .field-group -->
                            </td>
                        </tr>
