...
<div class="widget-header">
    <h3>Tambah Tunjangan Karyawan</h3>
</div> <!-- .widget-header -->
    ...
    <form method=POST enctype='multipart/form-data' action="<?php echo $aksi; ?>?modul=tunjangan_jabatan&act=tambah" class="form uniformForm validateForm">
        <div class="row">
            ...
            <div class="field-group ml-2">
                ...
                <div class="field">
                    <input type="text" name="besar_tunjangan" id="besar_tunjangan" size="20" class="validate[required]  formatCurrency form-control form-control-sm" />
                </div>
            </div> <!-- .field-group ml-2 -->
        </div>
